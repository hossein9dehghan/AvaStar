...
import {
  ...
  InputGroupButton,
  InputGroupInput,
} from "@avastar/ui/components/input-group"
      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            disabled={disabled}
          >
            <ComboboxTrigger aria-label={locale === "fa" ? "نمایش گزینه‌ها" : "Show options"} />
          </InputGroupButton>
        )}
        {showClear && <ComboboxClear disabled={disabled} aria-label={locale === "fa" ? "پاک‌کردن انتخاب" : "Clear selection"} />}
      </InputGroupAddon>
      {children}
    </InputGroup>
  )
    ...
    >
      ...
      {showRemove && (
        <ComboboxPrimitive.ChipRemove
          ...
          aria-label={locale === "fa" ? "حذف گزینه" : "Remove option"}
        >
          <XIcon className="pointer-events-none" />
        </ComboboxPrimitive.ChipRemove>
      )}
